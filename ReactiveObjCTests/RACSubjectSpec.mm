...
describe(@"RACSubject", ^{
	...
	it(@"should dispose the paired disposable when a subscription terminates", ^{
...
describe(@"RACReplaySubject", ^{
	...
	describe(@"with a capacity of 1", ^{
		...
		it(@"should send same latest value to multiple subscribers in another subscription", ^{
